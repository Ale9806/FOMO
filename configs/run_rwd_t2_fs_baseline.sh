...
for dataset in "${DATASETS[@]}"; do
  ...
  for model in "${MODELS[@]}"; do
    ...
    --att_adapt --unk_methods 'None' --unk_method 'None' --output_file ../outputs/RWD/T2/${model}/${dataset}/${ucn_fname}_fs_${num_shot}.csv  "
...
#SBATCH --output=../slurm_logs/RWD/T2/${model}/${dataset}/${ucn_fname}_fs_${num_shot}_out.txt
#SBATCH --error=../slurm_logs/RWD/T2/${model}/${dataset}/${ucn_fname}_fs_${num_shot}_err.txt
#SBATCH --mem=32gb
#SBATCH -c 2
